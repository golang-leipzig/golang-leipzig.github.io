...
LLM assisted active learning, the slides can be found [here](/downloads/lgo-60-nix-llm-slides.pdf) and we have [a recording on YouTube, too](https://youtu.be/vMZeDe8wJu8):
...
* [Translate](/downloads/lgo-60-nix-llm-slides.pdf#page=13): style transfer something new to something known, e.g. nix language to Pseudocode or similar
* Evaluation (or execution) [Tracing](/downloads/lgo-60-nix-llm-slides.pdf#page=14) (for simple cases)
* [Socratic debugging](/downloads/lgo-60-nix-llm-slides.pdf#page=15), using the [socratic method](https://en.wikipedia.org/wiki/Socratic_method) (below an early computer based socratic tutoring system, called "WHY", [from 1977](https://files.eric.ed.gov/fulltext/ED138297.pdf))

[![](/meetup-60/screenshot-2026-05-28-222132-dialogue-with-the-system.png)](https://files.eric.ed.gov/fulltext/ED138297.pdf#page=9)

* [Three Variations](/downloads/lgo-60-nix-llm-slides.pdf#page=16); learn by comparing solutions across competency levels
...
* why macos is also called [darwin](https://apple.stackexchange.com/a/401881/2644)
